            ...
            if (!PEAR::isError($result)) {
                if (count($result)) {
                    ...
                    foreach ($result as $row) {
                        // fix for Aleph record IDs
                        if(get_class($this->catalog->driver) == "AlephRestful") {
                            $query_id = $this->catalog->driver->makeDBSystemnumber($row['id']);
                        }
                        else {
                            $query_id = $row['id'];
                        }
                        $record = $this->db->getRecord($query_id);
