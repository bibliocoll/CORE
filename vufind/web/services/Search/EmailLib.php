...
class EmailLib extends Action
{
    ...
    public function launch()
    {
        ...
        if (isset($_GET['lightbox'])) {
            ...
            return $interface->fetch('Search/emailLib.tpl');
        } else {
            ...
            $interface->assign('subTemplate', 'emailLib.tpl');
            // For form POST:
    ...
    public function sendEmail($url, $to, $from, $message)
    {
        ...
        $subject = translate('Patron Email from VuFind');
        $interface->assign('from', $from);
        $interface->assign('message', $message);
        $interface->assign('msgUrl', $url);
        $body = $interface->fetch('Emails/contact.tpl');
