{if $user->cat_username}
  ...
  <div class="hold-form">
    ...
    <form action="{$path|escape}/Record/{$id|escape}/Hold{$formURL|escape}" method="post">
      ...
      {if $gatheredDetails.number}<input type="hidden" name="gatheredDetails[number]" value="{$gatheredDetails.number|escape}" />{/if}
