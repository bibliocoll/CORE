...
<h2>{$record.title[0]|escape:"html"}</h2>
...
<table>
  ...
  {if $showLists}
  <tr><td><label for="mytags">{translate text='Add Tags'} ({translate text='publicly viewable'})</label></td></tr>
  <tr><td><input type="text" name="mytags" id="mytags" value="" size="50"></td></tr>
  <tr><td colspan="2">{translate text='add_tag_note'}</td></tr>
  <tr><td><label for="notes">{translate text='Add a Note'} ({translate text='viewable for you only'})</label></td></tr>
