...
function getLightbox(module, action, id, lookfor, message, followupModule, followupAction, followupId, postParams)
{
    ...
    var params = 'method=GetLightbox' +
                 ...
                 '&followupId=' + encodeURIComponent(followupId);    var callback =
    {
...
function initAutocomplete(inputBox, suggestionBox, typeQuery)
// RDG: some modifications, get/set 3. Parameter from Template function call, see searchbox.tpl
{
    ...
    autoComp.generateRequest = function(query) {
        ...
        var o = typeQuery;
        if (o) {
            typeParam = "&type=" + encodeURIComponent(o);
        }
