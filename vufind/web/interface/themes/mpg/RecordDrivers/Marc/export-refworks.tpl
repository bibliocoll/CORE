...
{if $marcField}
JA {$marcField|getvalue:'t'}
SP {$marcField|getvalue:'g'|regex_replace:"/-.+/":""|regex_replace:"/[\s\.\,A-Za-z]/":""}
EP {$marcField|getvalue:'g'|regex_replace:"/^.+-[\sA-Za-z]/":""}
CY {$marcField|getvalue:'d'|regex_replace:"/,.+/":""}
{/if}
