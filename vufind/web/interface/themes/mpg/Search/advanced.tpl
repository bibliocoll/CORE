        ...
        <b class="btop"><b></b></b>
          <div class="advSearchContent">
            ...
            <div class="page">
              ...
              <br /><br />
              <input class="advSubmit" type="submit" name="submit" value="{translate text="Find"}"><br><br>
{* RDG: hide (selecting facets before starting the search does not make sense with multiple sources unless you add a dynamic selection via JS) *}
{*
             {if $facetList}
...
*}
              {/if}
{*
              <input class="advSubmit" type="submit" name="submit" value="{translate text="Find"}"><br>
*}
            </div>
          </div>
        <b class="bbot"><b></b></b>
