...
{js filename="search-rdg-extra.js"}
...
<div id="bd">
  <div id="yui-main" class="content">
	...
	<div id="noteFilterLocal" style="display:none"><a href="">{translate text="show me only what is in the library"}</a></div>
      ...
      <div class="searchtools">
        ...
        {else}
        <span class="notloggedin tooltip add" title="{translate text='Please login first to use this function!'}">{translate text="save_search"}</span>
        {/if}
      </div>
  ...
  {* vLib Database Suggestions (jQuery) *}
  <div class="yui-b">
    <div class="sidegroup">
      <div id="vLibBox">
	<h4>{translate text="Looking for more"}?</h4>
	<a href="http://vlib.mpg.de/">
          <img id="vLibLogo" src="{$path}/interface/themes/mpg/images/rdg/vlib-logo.gif"/>
        </a><br/>
	<span>{translate text="Continue your search in other databases"}:</span><br/>
        <button id="vLibButtonLaw" title="LAW">Law</button><br/>
	<button id="vLibButtonEconomics" title="ECON">Economics</button><br/>
	<button id="vLibButtonPsychology" title="PSY">Psychology</button><br/>
	<button id="vLibButtonPolitical" title="POL">Politics/Sociology</button><br/>
      </div>
    </div>
  </div>
  {* vLib Database Suggestions (jQuery) *}
